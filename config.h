...
static const char *fonts[] = {
    "Terminus:size=10.5",
		"xft:Cousine:pixelsize=12.5:antialias=true",
		"xft:Bitstream Vera Sans Mono:pixelsize=12.5:antialias=true",
...
/* tagging */
static const char *tags[] = { "term", "web", "mail", "chat", "files", "RDesktop", "VMs", "dragons" };
...
static const char *volup[] = { "amixer", "-c", "0", "set", "Master", "3dB+", NULL };
static const char *voldw[] = { "amixer", "-c", "0", "set", "Master", "3dB-", NULL };
static Key keys[] = {
...
/* statuscolors color definitions */
#define NUMCOLORS 4
static const char colors[NUMCOLORS][MAXCOLORS][8] = {
   // border   foreground  background
  // { "#cccccc", "#000000", "#cccccc" },
   { "#444444", "#bbbbbb", "#222222" },  // 0 = normal
  // { "#0066ff", "#ffffff", "#0066ff" },
